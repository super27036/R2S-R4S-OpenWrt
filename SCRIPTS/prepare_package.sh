...
git clone https://github.com/immortalwrt-collections/luci-app-vssr.git feeds/luci/applications/luci-app-vssr
ln -sf ../../../feeds/luci/applications/luci-app-vssr ./package/feeds/luci/luci-app-vssr
# -------------- #
