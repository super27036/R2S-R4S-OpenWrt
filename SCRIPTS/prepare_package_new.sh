...
### 获取额外的 LuCI 应用、主题 ###
# 从 ImmortalWRT 仓库中获取最新的 LuCI 应用和主题
git clone --depth 1 https://github.com/immortalwrt/luci.git /tmp/luci

# 更新 themes 目录
cp -rf /tmp/luci/themes/* feeds/luci/themes/

# 更新 applications 目录
cp -rf /tmp/luci/applications/* feeds/luci/applications/
